                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <li>
                            ...
                            >
                              <div className='relative'><FaBoxOpen className="absolute top-[-9px] right-[-5px] z-[-1] "/><FaShoppingCart className="z-1"/></div>All Product
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                            ...
                            >
                              <FaShoppingCart />Retailer
                            </NavLink>
                          </li>
                          <li>
                            <NavLink
                              to="/dashboard/wholesale"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                (isActive && '!text-white')
                              }
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        <AnimatedText name="Authentication" />
                        <svg
                          className={`absolute right-4 top-1/2 -translate-y-1/2 fill-current ${
                            open && 'rotate-180'
                          }`}
